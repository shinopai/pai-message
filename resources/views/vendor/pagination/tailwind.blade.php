...
>
  ...
  <div
    class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-center gap-[10px]"
    style="flex-direction: column;"
  >
    <div>
      <p class="text-[1.4rem] text-gray-700 leading-5">
    ...
    <div>
      <span class="relative z-0 inline-flex shadow-sm rounded-md">
        ...
        <span aria-current="page">
          <span
            class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium border border-gray-300 cursor-default leading-5 bg-[#EE0964] text-white"
            >{{ $page }}</span
          >
        </span>
        @else
